...
PolyLine::PolyLine() : width_(0.3f), length_(50), alpha_(1.0f), moveAlpha_(false), first_(true), clear_(false), allClearReset_(false),
...
void PolyLine::AddPosition(XMFLOAT3 pos1)
{
	if (first_) {
		positions_.clear();
		first_ = false;
